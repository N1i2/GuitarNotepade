...
public class RemoveLabelFromSegmentCommandHandler : IRequestHandler<RemoveLabelFromSegmentCommand, bool>
{
    private readonly IUnitOfWork _unitOfWork;
    private readonly ISongSegmentService _songSegmentService;

    public RemoveLabelFromSegmentCommandHandler(
    ...
    public async Task<bool> Handle(RemoveLabelFromSegmentCommand request, CancellationToken cancellationToken)
    {
        ...
        await _songSegmentService.RemoveLabelFromSegmentAsync(
            request.SegmentId,
            request.LabelId,
            cancellationToken);
