...
public class GetMyChordsQueryHandler : IRequestHandler<GetMyChordsQuery, PaginatedDto<ChordDto>>
{
    ...
    public async Task<PaginatedDto<ChordDto>> Handle(GetMyChordsQuery request, CancellationToken cancellationToken)
    {
